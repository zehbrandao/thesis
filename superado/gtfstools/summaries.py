...
def _stop_locations_by_route(feed, epsg):
    ...
    """
    subset = ['route_id', 'stop_id', 'stop_name', 'stop_sequence']
    
    col_order = ['route_id', 'direction_id', 'shape_id', 'stop_id',
                 'stop_name', 'stop_sequence', 'geometry']
    
    sort_on = ['route_id', 'direction_id', 'stop_sequence']
    
    stop_sequence = (_assemble_operational_data(feed)
